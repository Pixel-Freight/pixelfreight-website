            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert max-w-none">
                    <section className="mb-10">
                        ...
                        <p className="mb-4">
                            Welcome to PixelFreight. We respect your privacy and are committed to protecting your personal data.
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            ...
                            <Link href="mailto:privacy@pixelfreight.com" className="text-[var(--primary)] hover:underline">
                                privacy@pixelfreight.com
                            </Link>
                        </p>
                    </section>
                </div>
