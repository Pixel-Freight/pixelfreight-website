      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
        ...
        <div className="px-6 md:px-12 lg:px-18 py-20">
          <div className="max-w-4xl mx-auto text-left relative z-10">
            ...
            {/* Main heading */}
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-foreground leading-[1.1] py-1">
              We build <span className="text-primary">fast</span>, modern
              websites
              <br className="hidden md:block" /> and web apps.
            </h1>

            {/* Subtext */}
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mt-6 mb-12">
              Design. Code. Launch {" > "} All in one place.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="ghost" size="lg" as="link" href="/web">
                Learn What We Do
              </Button>
            </div>
          </div>
